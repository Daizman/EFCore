...
## План работы:
[ ] Сделать модели для БД.
[ ] Создать контекст БД. С настройкой автосоздания.
[ ] Сделать конфигурацию сущностей БД через FluentAPI. С индексами и ограничениями.
[ ] Сделать начальную миграцию.
[ ] Сделать заполнение жанров.
[ ] Сделать заполнение книг, авторов, издательств.
[ ] Подключить сваггер и сделать вывод api.
[ ] Сделать представления в БД.
[ ] Сделать ХП для работы с авторами.
[ ] Сделать DTO для отправки в ответ на запросы к API.
[ ] Сделать маппинг модели на DTO и наоборот.
[ ] Сделать API для базовых CRUD-операций.
[ ] Добавить рейтинг в БД без потери сущностей.
[ ] Сделать запросы из списка.
